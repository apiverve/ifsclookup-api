...
/**
 * Client for the IFSC Lookup API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/ifsclookup?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/ifsclookup';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\IfsclookupClient] {$message}\n";
        }
    }
}
