// Package ifsclookup provides a Go client for the IFSC Lookup API.
//
// For more information, visit: https://apiverve.com/marketplace/ifsclookup?utm_source=go&utm_medium=readme
package ifsclookup
...
const (
	baseURL        = "https://api.apiverve.com/v1/ifsclookup"
	defaultTimeout = 30 * time.Second
)

// Client is the IFSC Lookup API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new IFSC Lookup API client.
...
// Execute makes a request to the IFSC Lookup API with typed parameters.
//
...
//   - ifsc (required): string - The IFSC code to get information about
