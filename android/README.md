...
```gradle
dependencies {
    implementation 'com.github.apiverve:ifsclookup-api:1.1.13'
}
```
...
```java
import com.apiverve.ifsclookup.IFSCLookupAPIClient;
import com.apiverve.ifsclookup.APIResponse;
import com.apiverve.ifsclookup.APIException;

// Initialize the client
IFSCLookupAPIClient client = new IFSCLookupAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("ifsc", "SBIN0005943");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/ifsclookup](https://docs.apiverve.com/ref/ifsclookup)
...
- **Documentation:** [https://docs.apiverve.com/ref/ifsclookup](https://docs.apiverve.com/ref/ifsclookup)
- **Issues:** [GitHub Issues](https://github.com/apiverve/ifsclookup-api/issues)
